import sys
sys.path.append('/home/dvalsamis/Documents/projects/GAS-Net-main')

import torch
import torch.nn as nn
import torch.nn.functional as F
from gasnet.encoder import build_backbone
from gasnet.decoder import build_decoderGASN
from gasnet.data_utils import get_transform
import os 
...
class CDNet_L(nn.Module):
    def __init__(self, backbone='resnet18', output_stride=16, f_c=64, freeze_bn=False, in_c=3):
        ...
        self.decoder = build_decoderGASN(f_c, BatchNorm)
        ...
        # self.conv_up = nn.Upsample(scale_factor=2, mode='bilinear')
    ...
    def forward(self, hr_img1, hr_img2):
        ...
        concat_feature = self.conv_final(torch.cat([x1, x2], dim=1))
                    
        output = torch.sigmoid(concat_feature)
        return output
