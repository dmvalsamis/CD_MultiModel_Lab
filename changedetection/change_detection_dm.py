...
def change_detection(dataset_name, input_rasters):
    ...
    path = f'/home/dvalsamis/Documents/data/CBMI/CBMI_0.3/Predictions/Depth_2/Onera_Tr/{dataset_name}'
    # Load change detection model
    saved_model = '/home/dvalsamis/Documents/projects/saved_models/depth:2_rgb_0.1_0.0001_0.001_50_convclastwo[0.2  2.25].h5'         
