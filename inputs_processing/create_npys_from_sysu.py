...
#### Images locations  ####
IMAGES_PATH = '/home/dvalsamis/Documents/data/sysu/original_set/total/'
TRAIN_LABEL_PATH = '/home/dvalsamis/Documents/data/sysu/original_set/train/label/'
TEST_LABEL_PATH = '/home/dvalsamis/Documents/data/sysu/original_set/test/label/'

#### Save targets for the npy files ####
SAVE_IMAGES = '/home/dvalsamis/Documents/data/sysu/SYSU_NPY/total_NPY/'
SAVE_TRAIN_LABELS = '/home/dvalsamis/Documents/data/sysu/SYSU_NPY/train_labels_NPY/'
SAVE_TEST_LABELS = '/home/dvalsamis/Documents/data/sysu/SYSU_NPY/test_labels_NPY/'
...
def make_image_pairs(images_path, save_images):
    folder_a = os.path.join(images_path, 'time1')
    folder_b = os.path.join(images_path, 'time2')
    ...
    images_set.to_csv(os.path.join(save_images, 'Sysu_set.csv'), index=False)

# Call the function
make_image_pairs(IMAGES_PATH, SAVE_IMAGES)

path1 = os.path.join(IMAGES_PATH, 'time1')
