...
onera_train_target =  '/data/valsamis_data/data/sysu/SYSU_NPY/aug_train_data/'  
onera_test_target = '/data/valsamis_data/data/sysu/SYSU_NPY/aug_test_data/'
...
cd_model_name = "CD_Simple_"+"Sysu_"+model_id+".h5"
...
log_params_sim1("Task 1 (T)", "Linear", 'ASPP', weight_par, depth, "Softmax", LEARNING_RATE, 'Adam', EPOCHS, 'weighted_categorical_crossentropy', BATCH_SIZE, rec, spec, prec, f_m, acc, "SYSU Set", 96, NORM, pretext_model,cd_model_name)
