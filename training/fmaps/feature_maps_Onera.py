...
cd_model_name = 'CD_Simple_Onera_0a8d'
...
# y_pred_single = y_pred[0]  # Assuming the first element is the desired output

# pos = 57
# fig, ax = plt.subplots(2, 3, figsize=(15, 10), constrained_layout=True)

# ax[0, 0].imshow(create_rgb(nonNorm1[pos], channel))
...
# ax[0, 2].imshow(create_rgb(nonNorm2[pos], channel))
# ax[0, 2].set_title('Right Image', fontsize=20)
# ax[0, 2].axis('off')

# ax[1, 0].imshow(create_rgb(nonNorm1[pos], channel))
...
# ax[1, 2].imshow(create_rgb(nonNorm2[pos], channel))
...
# Example usage
feature_maps_dir = '/home/dvalsamis/Documents/projects/Change_detection_SSL_Siamese/fonera/fmaps_57'
initial_inputs = [X1, X2]
