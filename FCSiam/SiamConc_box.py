...
log_dir = '/home/dvalsamis/Documents/projects/Change_detection_SSL_Siamese/events'
...
for run in range(64):
    ...
    cd_model_name = f"FCSiamConc_CBMI_{model_id}.h5"
...
metrics_df.to_csv('metrics_64_models.csv', index=False)
...
# Save the plot
output_path = '/home/dvalsamis/Documents/projects/Change_detection_SSL_Siamese/FCSiam/Box_plots/Conc_boxplot_metrics_64_runs.png'
